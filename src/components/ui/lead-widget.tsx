      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="w-[350px] sm:w-[400px] bg-white rounded-2xl shadow-2xl overflow-hidden border border-slate-200 mb-2 origin-bottom-right"
          >
            {/* Header */}
            <div className="bg-[#111827] p-5 flex justify-between items-start relative overflow-hidden">
                ...
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-4">
                  ...
                  <form className="space-y-3" onSubmit={(e) => e.preventDefault()}>
                    <div>
                      ...
                      <input type="text" placeholder="Alex Mercer" className="w-full px-3 py-2 border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#FF6B35]/20 focus:border-[#FF6B35] text-slate-900" />
                    </div>
                    <div>
                      <label className="text-xs font-semibold text-slate-700 mb-1 block">Email Address</label>
                      <input type="email" placeholder="alex@company.com" className="w-full px-3 py-2 border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#FF6B35]/20 focus:border-[#FF6B35] text-slate-900" />
                    </div>
                    <div>
                      <label className="text-xs font-semibold text-slate-700 mb-1 block">Phone Number</label>
                      <input type="tel" placeholder="+91 98765 43210" className="w-full px-3 py-2 border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#FF6B35]/20 focus:border-[#FF6B35] text-slate-900" />
                    </div>
                    <div>
                      <label className="text-xs font-semibold text-slate-700 mb-1 block">Website URL</label>
                      <input type="url" placeholder="https://yourcompany.com" className="w-full px-3 py-2 border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#FF6B35]/20 focus:border-[#FF6B35] text-slate-900" />
                    </div>
                    <button type="submit" className="w-full bg-[#FF6B35] hover:bg-[#e65a28] text-white font-semibold py-3 rounded-lg flex items-center justify-center gap-2 transition-colors mt-2">
                      <PhoneCall size={18} /> Request Callback Now
                    </button>
                  </form>
                </motion.div>
              )}
            ...
            <div className="p-5 bg-slate-50 border-t border-slate-200">
              <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-3">Or reach us directly</p>
            ...
            {/* Branding */}
            <div className="bg-slate-100 py-2 px-5 flex items-center justify-between">
